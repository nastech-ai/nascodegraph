 ...
 * ```
 */
export class NasCodeGraphError extends Error {
 ...
 */
export class FileError extends NasCodeGraphError {
 ...
 */
export class ParseError extends NasCodeGraphError {
  readonly filePath: string;
 ...
 */
export class DatabaseError extends NasCodeGraphError {
 ...
 */
export class SearchError extends NasCodeGraphError {
 ...
 */
export class VectorError extends NasCodeGraphError {
  constructor(message: string, operation: string, cause?: Error) {
 ...
 */
export class ConfigError extends NasCodeGraphError {
