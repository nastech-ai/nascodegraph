...
export function buildNode25BlockBanner(nodeVersion: string): string {
  ...
  return [
    ...
    'version mid-indexing. See https://github.com/nastech-ai/nasnascodegraph/issues/81',
    '',
...
export function buildNodeTooOldBanner(nodeVersion: string): string {
  ...
  return [
    ...
    `[NasCodeGraph] Unsupported Node.js version: ${nodeVersion}`,
    sep,
    `NasCodeGraph requires Node.js ${MIN_NODE_MAJOR} or newer. Older versions lack`,
