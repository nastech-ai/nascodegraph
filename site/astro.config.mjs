...
// Project page on GitHub Pages: https://colbymchenry.github.io/nascodegraph/
// `site` + `base` make every internal link resolve under the /nascodegraph/ prefix.
			...
			social: [
				{
					icon: 'github',
					label: 'GitHub',
					href: 'https://github.com/colbymchenry/nascodegraph',
				},
			],
			customCss: [
