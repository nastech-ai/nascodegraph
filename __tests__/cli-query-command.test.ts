/**
 * `nascodegraph query` score rendering (#1045).
 *
...
describe('nascodegraph query — score rendering (#1045)', () => {
  let tempDir: string;

  beforeEach(async () => {
    tempDir = fs.mkdtempSync(path.join(os.tmpdir(), 'nascodegraph-query-cmd-'));
