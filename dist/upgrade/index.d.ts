 ...
 */
export declare const REPO = "nastech-ai/nascodegraph";
export declare const NPM_PACKAGE = "@nastech-ai/nascodegraph";
export declare const INSTALL_SH_URL = "https://raw.githubusercontent.com/nastech-ai/nascodegraph/main/install.sh";
