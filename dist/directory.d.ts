 ...
 */
export declare const NASTECHGRAPH_DIR: string;
/**
 ...
 */
export declare function isNasCodeGraphDataDir(name: string): boolean;
/**
 * Get the .nascodegraph directory path for a project
 */
export declare function getNasCodeGraphDir(projectRoot: string): string;
/**
...
export declare function findNearestNasCodeGraphRoot(startPath: string): string | null;
/**
