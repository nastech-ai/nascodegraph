...
const EXHAUSTION_REASON = 'OS watch/file limit exhausted; auto-sync disabled. Run `nascodegraph sync` ' +
...
class FileWatcher {
    ...
    isAlwaysIgnored(rel) {
        ...
        return ((0, directory_1.isNasCodeGraphDataDir)(top) ||
        ...
        try {
            ...
            if (err instanceof LockUnavailableError) {
                ...
                if (this.lockRetryCount > MAX_LOCK_RETRIES) {
                    this.degrade('NasCodeGraph file lock held by another process past the retry budget; ' +
