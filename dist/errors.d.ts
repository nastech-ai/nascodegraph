 ...
 * ```
 */
export declare class NasCodeGraphError extends Error {
 ...
 */
export declare class FileError extends NasCodeGraphError {
 ...
 */
export declare class ParseError extends NasCodeGraphError {
    readonly filePath: string;
 ...
 */
export declare class DatabaseError extends NasCodeGraphError {
 ...
 */
export declare class SearchError extends NasCodeGraphError {
 ...
 */
export declare class VectorError extends NasCodeGraphError {
    constructor(message: string, operation: string, cause?: Error);
}
/**
 * Error with configuration
 */
export declare class ConfigError extends NasCodeGraphError {
    constructor(message: string, details?: Record<string, unknown>);
}
/**
 * Simple logger for NasCodeGraph operations
 *
