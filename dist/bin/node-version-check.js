 ...
 * reliably crashes NasCodeGraph with `Fatal process out of memory: Zone`
...
/**
 * Build the bordered banner shown when NasCodeGraph detects an
...
function buildNode25BlockBanner(nodeVersion) {
    ...
    return [
        sep,
        `[NasCodeGraph] Unsupported Node.js version: ${nodeVersion}`,
        sep,
        'Node.js 25.x has a V8 WASM JIT (turboshaft) Zone allocator bug that',
        'crashes with `Fatal process out of memory: Zone` when NasCodeGraph',
        'compiles tree-sitter grammars. NasCodeGraph WILL crash on this Node',
        'version mid-indexing. See https://github.com/nastech-ai/nascodegraph/issues/81',
        '',
        ...
        '  NASTECHGRAPH_ALLOW_UNSAFE_NODE=1 nascodegraph ...',
        sep,
    ].join('\n');
}
/**
 * Lowest supported Node.js major version. Matches the `engines` floor in
 * package.json. Below this, NasCodeGraph relies on language features / native APIs
...
/**
 * Build the bordered banner shown when NasCodeGraph detects a Node.js major below
...
function buildNodeTooOldBanner(nodeVersion) {
    ...
    return [
        ...
        `[NasCodeGraph] Unsupported Node.js version: ${nodeVersion}`,
        sep,
        `NasCodeGraph requires Node.js ${exports.MIN_NODE_MAJOR} or newer. Older versions lack`,
        'language features and native APIs NasCodeGraph depends on, and are not',
        'tested or supported.',
        '',
        'Fix: install Node.js 22 LTS:',
        '  nvm install 22 && nvm use 22                          # nvm',
