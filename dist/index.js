...
exports.NasCodeGraph = exports.MCPServer = exports.LockUnavailableError = exports.FileWatcher = exports.MemoryMonitor = exports.throttle = exports.debounce = exports.processInBatches = exports.FileLock = exports.Mutex = exports.defaultLogger = exports.silentLogger = exports.getLogger = exports.setLogger = exports.ConfigError = exports.VectorError = exports.SearchError = exports.DatabaseError = exports.ParseError = exports.FileError = exports.NasCodeGraphError = exports.loadAllGrammars = exports.loadGrammarsForLanguages = exports.initGrammars = exports.getSupportedLanguages = exports.isGrammarLoaded = exports.isLanguageSupported = exports.detectLanguage = exports.NASTECHGRAPH_DIR = exports.findNearestNasCodeGraphRoot = exports.isInitialized = exports.getNasCodeGraphDir = exports.QueryBuilder = exports.DatabaseConnection = exports.getDatabasePath = void 0;
...
Object.defineProperty(exports, "getNasCodeGraphDir", { enumerable: true, get: function () { return directory_3.getNasCodeGraphDir; } });
Object.defineProperty(exports, "isInitialized", { enumerable: true, get: function () { return directory_3.isInitialized; } });
Object.defineProperty(exports, "findNearestNasCodeGraphRoot", { enumerable: true, get: function () { return directory_3.findNearestNasCodeGraphRoot; } });
Object.defineProperty(exports, "NASTECHGRAPH_DIR", { enumerable: true, get: function () { return directory_3.NASTECHGRAPH_DIR; } });
...
Object.defineProperty(exports, "NasCodeGraphError", { enumerable: true, get: function () { return errors_1.NasCodeGraphError; } });
...
class NasCodeGraph {
    ...
    constructor(db, queries, projectRoot) {
        ...
        this.fileLock = new utils_1.FileLock(path.join((0, directory_2.getNasCodeGraphDir)(projectRoot), 'nascodegraph.lock'));
        this.wireLayers();
    }
    /**
    ...
    async indexAll(options = {}) {
        return this.indexMutex.withLock(async () => {
            ...
            try {
                ...
                if (result.success && result.filesIndexed > 0) {
                    try {
                        this.queries.setMetadata('indexed_with_version', version_1.NasCodeGraphPackageVersion);
...
exports.NasCodeGraph = NasCodeGraph;
// Default export
exports.default = NasCodeGraph;
