...
export declare const NASTECHGRAPH_SECTION_START = "<!-- NASTECHGRAPH_START -->";
export declare const NASTECHGRAPH_SECTION_END = "<!-- NASTECHGRAPH_END -->";
/**
