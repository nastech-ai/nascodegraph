...
exports.getNasCodeGraphPermissions = getNasCodeGraphPermissions;
 ...
 */
function getNasCodeGraphPermissions() {
...
function upsertInstructionsEntry(file) {
    const action = replaceOrAppendMarkedSection(file, instructions_template_1.NASTECHGRAPH_INSTRUCTIONS_BLOCK, instructions_template_1.NASTECHGRAPH_SECTION_START, instructions_template_1.NASTECHGRAPH_SECTION_END);
