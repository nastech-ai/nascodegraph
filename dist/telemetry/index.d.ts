 ...
 */
export declare const TELEMETRY_ENDPOINT = "https://telemetry.getnascodegraph.com/v1/events";
export declare const TELEMETRY_DOCS = "https://github.com/nastech-ai/nascodegraph/blob/main/TELEMETRY.md";
