...
exports.TELEMETRY_ENDPOINT = 'https://telemetry.getnascodegraph.com/v1/events';
exports.TELEMETRY_DOCS = 'https://github.com/nastech-ai/nascodegraph/blob/main/TELEMETRY.md';
...
class Telemetry {
    ...
    firstRunNotice() {
        ...
        this.writeStderr(`nascodegraph collects anonymous usage stats (no code, paths, or names) — ` +
            `"nascodegraph telemetry off" or NASTECHGRAPH_TELEMETRY=0 disables. Details: ${exports.TELEMETRY_DOCS}\n`);
    }
    /**
    ...
    async send(lines, timeoutMs) {
        ...
        const endpoint = this.env.NASTECHGRAPH_TELEMETRY_ENDPOINT || exports.TELEMETRY_ENDPOINT;
