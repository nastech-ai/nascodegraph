'use strict';
//
// Programmatic / embedded SDK entry for @nastech-ai/nascodegraph (issue #354).
//
...
// API — `require("@nastech-ai/nascodegraph")` returning the NasCodeGraph class et al.
//
// The compiled library + its production dependencies (web-tree-sitter,
// tree-sitter-wasms, …) ship INSIDE the per-platform bundle, at
//   @nastech-ai/nascodegraph-<platform>-<arch>/lib/dist/index.js
...
function resolveLibrary() {
  ...
  throw new Error(
    ...
    '      npm i @nastech-ai/nascodegraph --registry=https://registry.npmjs.org\n' +
    '  - or run the CLI once (e.g. `npx @nastech-ai/nascodegraph status`) to\n' +
